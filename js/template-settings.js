export const SETTINGS_TEMPLATE=String.raw`<section aria-labelledby="settings-title" class="modal-layer" id="settings-panel">
...
<button class="button button--primary button--full" type="submit">Open Pace Notes</button>
</form>
<a class="help-link" href="https://account.mapbox.com/access-tokens/" rel="noreferrer" target="_blank">Create a free Mapbox token ↗</a>
<p class="safety-note">Designed for closed-course or co-driver use. Set the route before driving and do not interact with the screen while moving.</p>
</div>
</section>`;